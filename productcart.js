...
function calculate() {
    ...
    var pricePerVolume = productData.find((val)=>val.productName === productName).pricePerVolume
...
let checkOut = document.getElementById('check-out').addEventListener('click', () => {
   
    let totalSum = document.getElementById('totalSum')
    let totalAmount = totalSum.innerHTML
